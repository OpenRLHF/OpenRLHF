...
if __name__ == "__main__":
    ...
    # custom
    parser.add_argument("--search_algo", type=lambda x: x if x in {'sampling', 'beamsearch', 'litesearch'} else argparse.ArgumentTypeError(f"Only sampling, beamsearch, litesearch are available"), default="sampling")
