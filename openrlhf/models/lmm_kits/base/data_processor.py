...
class MMInputs:
    ...
    forward_inputs: Optional[BatchFeature | dict] = (
        None  # some models need extra inputs for forward, even if given input_embeds
    )
    extra_info: Optional[BatchFeature | dict] = (
        None  # Reserved item for other usages. Now used for batching and splitting.
    )
