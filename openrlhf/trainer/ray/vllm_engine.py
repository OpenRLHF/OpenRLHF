...
class LLMRayActor(BaseLLMRayActor):
    ...
    def update_weights_from_ipc(self, name, dtype, shape, ipc_handles, empty_cache=False):
        return self.llm.collective_rpc("update_weights_from_ipc", args=(name, dtype, shape, ipc_handles, empty_cache))
