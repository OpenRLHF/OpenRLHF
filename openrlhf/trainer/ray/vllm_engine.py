...
class LLMRayActor:
    ...
    def update_weight_cuda_ipc(self, name, dtype, shape, ipc_handle, empty_cache=False):
        return self.llm.collective_rpc("update_weight_cuda_ipc", args=(name, dtype, shape, ipc_handle, empty_cache))
