...
data_fpath_list = [
    "/apdcephfs/private_antewang/RLVF/data_qwen/Qwen2.5-Math/evaluation/data/gsm8k/train.jsonl",
    "/apdcephfs/private_antewang/RLVF/data_qwen/Qwen2.5-Math/evaluation/data/math/train.jsonl",
    "/apdcephfs/private_antewang/RLVF/data_qwen/Qwen2.5-Math/evaluation/data/gsm8k/test.jsonl",
    "/apdcephfs/private_antewang/RLVF/data_qwen/Qwen2.5-Math/evaluation/data/math/test.jsonl"
]
