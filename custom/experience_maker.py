...
class NaiveExperienceMaker(ABC):
    ...
    def generate_samples(self, all_prompts: List[str], **generate_kwargs) -> List[Samples]:
        ...
        # inputs = self.tokenize_fn(all_prompts, self.prompt_max_len, device="cuda")
        ...
        # )
        # print(self.tokenizer.batch_decode(sequences.cpu(), skip_special_tokens=True))
    ...
    def search_samples(self, all_prompts: List[str], **generate_kwargs) -> List[Samples]:
        ...
        for i in range(0, len(all_prompts), args.micro_rollout_batch_size):
            ...
            for prompt in _all_prompts: # directly use input_ids is more efficient, check if left padding?
