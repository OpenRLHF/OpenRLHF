...
pip install openrlhf[vllm]              # + vLLM 0.16.0 (recommended)
...
> [!TIP]
> We recommend **vLLM 0.16.0+** for best performance. See [Dockerfiles](./dockerfile/) and [Nvidia-Docker Install Script](./examples/scripts/nvidia_docker_install.sh).
