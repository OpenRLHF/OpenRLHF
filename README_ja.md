...
pip install openrlhf[vllm]              # + vLLM 0.17.0（推奨）
...
> [!TIP]
> 最高のパフォーマンスのために**vLLM 0.17.0+**を推奨します。[Dockerfiles](./dockerfile/)と[Nvidia-Dockerインストールスクリプト](./examples/scripts/nvidia_docker_install.sh)を参照してください。
