...
**効率の最適化**
- SFT/DPO/RL学習のサンプルパッキング（`--fsdp.packing_samples`）
...
- FlashAttention / SDPA / eager の選択（`--fsdp.attn_implementation`）
...
> [!TIP]
> このブランチは **NVIDIA PyTorch 25.11**、**torch 2.10**、**NeMo AutoModel main commit `17ed5796bdc220c314c9fd6bd718a773a3642521`**、**vLLM 0.19.1** を対象にしています。Dion は PyPI ではなく `github.com/microsoft/dion` からインストールします。
