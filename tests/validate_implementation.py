...
def validate_fsdp2_specific() -> List[ValidationResult]:
    ...
    try:
        ...
        if hasattr(FSDP2Strategy, '_recreate_scheduler'):
            ...
            results.append(ValidationResult(False, "FSDP2 scheduler recreation", "_recreate_scheduler method not found"))
...
def validate_deepspeed_specific() -> List[ValidationResult]:
    ...
    try:
        ...
        if hasattr(DeepspeedStrategy, 'setup_ring_attn'):
            ...
            results.append(ValidationResult(False, "DeepSpeed Ring Attention support", "setup_ring_attn method not found"))
...
def validate_cli_arguments() -> List[ValidationResult]:
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location(
            "train_sft",
            os.path.join(os.path.dirname(__file__), "..", "openrlhf", "cli", "train_sft.py")
        )
