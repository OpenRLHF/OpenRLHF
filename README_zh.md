...
基于 PyTorch FSDP2/DTensor，并集成 [NeMo AutoModel](https://docs.nvidia.com/nemo/automodel/) 处理模型构建、TP/CP/EP mesh、activation checkpointing、LoRA/QLoRA 与 FSDP2 包装；OpenRLHF 保持 RL 训练循环、Ray 编排、vLLM 权重同步和 checkpoint 流程轻量。
