...
pip install openrlhf[vllm]              # + vLLM 0.17.1（推荐）
...
> [!TIP]
> 我们推荐 **vLLM 0.17.1+** 以获得最佳性能。参见 [Dockerfiles](./dockerfile/) 和 [Nvidia-Docker 安装脚本](./examples/scripts/nvidia_docker_install.sh)。
