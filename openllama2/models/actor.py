...
class Actor(nn.Module):
    ...
    def __init__(self, pretrain_or_model, from_config=False, lora_rank: int = 0, lora_train_bias: str = 'none') -> None:
        super().__init__()
        if isinstance(pretrain_or_model, str):
            if from_config:
                ...
                self.model = AutoModelForCausalLM.from_pretrained(pretrain_or_model, torch_dtype="auto", trust_remote_code=True)
        else:
    ...
    def forward(self,
                ...
                return_output = False) -> torch.Tensor:
