...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--num_actor_nodes",
        type=int,
        help="num of nodes to use to host actor model",
        default=1,
    )
    parser.add_argument(
        "--num_critic_nodes",
        type=int,
        help="num of nodes to use to host critic model",
        default=1,
    )
    parser.add_argument(
        "--num_initial_nodes",
        type=int,
        help="num of nodes to use to host initial model",
        default=1,
    )
    parser.add_argument(
        "--num_reward_nodes",
        type=int,
        help="num of nodes to use to host reward model",
        default=1,
    )
